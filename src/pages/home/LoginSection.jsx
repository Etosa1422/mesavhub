...
const LoginSection = () => {
  ...
  return (
    <section id="login-section" className="bg-gray-50 dark:bg-[#0a0a0f] py-20 px-6">
          ...
          <div className="bg-white dark:bg-[#0f0f1a] p-10 flex flex-col justify-center">
            ...
            <form onSubmit={loginUser} className="space-y-5">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link to="/forgot-password" className="text-brand-600 dark:text-brand-400 text-xs hover:underline">Forgot password?</Link>
              </div>
