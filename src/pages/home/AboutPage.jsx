...
const values = [
  ...
  { icon: Globe, title: "Built for everyone", desc: "From a solo creator in Lagos to a reseller agency in London, Mesavhub is designed to serve users at every scale and location." },
...
const team = [
  { name: "Mesavhub Team", role: "Founders & Engineers", emoji: "?" },
  ...
  <div className="min-h-screen bg-white dark:bg-[#0a0a0f]">
    ...
    <section className="relative pt-28 pb-20 px-6 overflow-hidden bg-gradient-to-b from-brand-50 via-white to-white dark:from-[#0a0a0f] dark:via-[#0a0a0f] dark:to-[#0a0a0f]">
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-lg leading-relaxed max-w-2xl mx-auto">
          Mesavhub is an all-in-one social media marketing panel and virtual number verification platform — built for creators, marketers, and resellers worldwide.
        </p>
      </div>
    </section>
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400 leading-relaxed mb-4">
            We started Mesavhub because the tools for growing a social media presence were either too expensive, too complicated, or simply unreliable. We set out to fix that.
          </p>
          <p className="text-gray-500 dark:text-gray-400 leading-relaxed">
            Today, Mesavhub serves over 70,000 users across 150+ countries — from first-time content creators to professional marketing agencies managing thousands of orders per month.
          </p>
        </div>
    ...
    <section className="bg-gray-50 dark:bg-[#0a0a0f] py-24 px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <h2 className="text-4xl font-black text-gray-900 dark:text-white mb-12">People behind Mesavhub</h2>
    ...
    <section className="bg-white dark:bg-[#0f0f1a] py-20 px-6 border-t border-gray-100 dark:border-white/5">
      <div className="max-w-2xl mx-auto text-center">
        <h2 className="text-3xl font-black text-gray-900 dark:text-white mb-3">Join thousands of Mesavhub users</h2>
