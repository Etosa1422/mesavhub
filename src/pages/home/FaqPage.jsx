...
const faqs = {
  ...
  smm: [
    ...
    { q: "Are the followers and likes real?", a: "Yes — all services on Mesavs use real, active accounts. We do not use bots. Follower retention rates are consistently high because the engagement comes from genuine profiles." },
  ...
  billing: [
    ...
    { q: "Can I get a refund to my original payment method?", a: "Refunds are returned to your Mesavs balance, not to the original payment method. We do not process cash refunds. Exceptions may be considered for technical billing errors — contact support." },
